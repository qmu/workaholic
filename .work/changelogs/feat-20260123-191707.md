...
## Changed
- Rebalance performance-analyst to value iteration over perfection ([3f6691e](https://github.com/qmu/workaholic/commit/3f6691e)) - [ticket](20260124012341-performance-analyst-value-iteration.md)
...
- Refactor story to be the single source for PR description ([faa8b5a](https://github.com/tamurayoshiya/workaholic/commit/faa8b5a)) - [ticket](20260124005056-story-as-pr-description.md)
