...
When creating a pull request with `/pull-request`, any remaining unfinished tickets in `.work/tickets/` should not be silently ignored. The command should warn the user and automatically move these tickets to the icebox directory, ensuring no work is accidentally lost or forgotten.
...
- `.work/tickets/` - Source of queued tickets to check
- `.work/tickets/icebox/` - Destination for deferred tickets
...
- README.md in `.work/tickets/` should not be treated as a ticket
