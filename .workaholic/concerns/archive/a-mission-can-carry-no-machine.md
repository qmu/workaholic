...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Promoted to ticket 20260716163004-mission-floor-machine-checks.md (2026-07-16 triage-to-zero): drive-authorized.sh refuses a 0/0 mission with reason no_plan. Risk now tracked in the queue.
