...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Structural: a PreToolUse hook receives only tool_input.file_path and cannot know its caller; the /explain staging file moved in-repo instead of widening the gate, pinned by test.
