...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: The whitespace tokenizer deliberately avoids a full shell parser (documented in the hook header); the residual false-positive on quoted literals is agent guidance, not code.
