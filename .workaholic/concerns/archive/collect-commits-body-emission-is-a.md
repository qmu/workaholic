...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: The link is wired and test-guarded: collect-commits.sh emits the body, report Phase 2 feeds it to the section-reviewer, and regression tests assert emission and multi-line preservation.
