...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Promoted to ticket 20260716163005-release-scan-and-ship-gaps.md (2026-07-16 triage-to-zero): make the pre-merge release-note push failure a hard stop with a rejected-push test. Risk now tracked in the queue.
