...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Promoted to ticket 20260716163001-commit-sh-argument-and-subject-hardening.md (2026-07-16 triage-to-zero): error on a trailing flag instead of treating it as a file path. Risk now tracked in the queue.
