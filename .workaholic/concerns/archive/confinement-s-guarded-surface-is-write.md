...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Write/Edit-only surface is the documented threat-model choice (CLAUDE.md Repository confinement); Bash/MCP blindness is how file-request.sh and /explain's PDF write function.
