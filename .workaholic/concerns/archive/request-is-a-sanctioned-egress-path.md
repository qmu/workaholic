...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: A deliberate, justified design decision with its guardrail green: the realLeaks tripwire test still asserts the mechanical checks pass those sentences, proving the human gate is the control.
