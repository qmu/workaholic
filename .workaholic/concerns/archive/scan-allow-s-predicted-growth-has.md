...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Promoted to ticket 20260716163005-release-scan-and-ship-gaps.md (2026-07-16 triage-to-zero): collapse the five per-ticket globs into one prefix-scoped exemption. Risk now tracked in the queue.
