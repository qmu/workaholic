...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Whole-line subtraction is inherent to a line-based deterministic scanner; pass 1 (unmistakable shapes) is never subtracted, and the header no longer overclaims. Low-severity documented trade-off.
