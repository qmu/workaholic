...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: The lens/carry asymmetry is a decided, documented trade-off (unasked nudge vs requested handoff report), stated in mission/SKILL.md and pinned by test.
