...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Irreducible by the concern's own framing; the deliberate resolution (err toward flagging, bounded primitive list, reasoning preserved in secret-patterns.sh) is intact.
