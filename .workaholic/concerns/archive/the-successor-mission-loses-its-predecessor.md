...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: No-worktree-inheritance is documented design (1:1 slug keying; inheriting would silence the lens), and the Replan flow (096d63f1) is now the sanctioned flesh-out path for a carried successor.
