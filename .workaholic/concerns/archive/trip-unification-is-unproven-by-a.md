...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: Promoted to ticket 20260716163007-live-validation-session.md (2026-07-16 triage-to-zero): run and record a live /trip in both modes. Risk now tracked in the queue.
