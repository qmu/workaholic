...
resolved_by_pr: 
resolved_by_commit: 
closed_reason: The PostToolUse position is a documented deliberate stance (a PreToolUse hook cannot inspect content Write is about to create); mid-authoring friction was a knowingly accepted cost.
