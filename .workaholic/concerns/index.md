...
* [Installed-plugin lag makes new validators inert until this branch merges](installed-plugin-lag-makes-new-validators.md)
...
* [Sibling-PR detection depends on the mission slug appearing in a PR title or body](sibling-pr-detection-depends-on-the.md)
* [Unreachable configured origin now hard-fails mission-worktree creation](unreachable-configured-origin-now-hard-fails.md)
