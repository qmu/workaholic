...
* moderations/ - the /moderate tick log, one file per UTC day (an operational log, not knowledge: no type:, no index, and since 2026-09-01 not on this branch at all - it lives on its own branch, gather/scripts/log-ref.sh)
