...
- [ ] Every visible receipt identifies the request in the person's language and promises only the workflow state actually reached. (#20260908124419-define-the-human-centered-slack-acknowledgement-contract.md)
- [ ] Related rapid asks can produce one compact subject-to-issue acknowledgement while every source message retains durable handled state. (#20260908124419-group-burst-receipts-while-preserving-per-message-durable-state.md)
