...
- [ ] The issue writer takes an assignee and accepts this repository as its target. (#20260817133224-give-the-fb-issue-writer-an-assignee-and-this-repo.md)
- [ ] A destination-less `/fb` opens that assigned issue, writes no record on that path,
