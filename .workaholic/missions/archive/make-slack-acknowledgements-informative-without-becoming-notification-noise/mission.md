...
- [x] Tests assert required facts, grouping, deduplication, and delivery separately from one mandatory prose sentence. (#20260908124419-test-acknowledgement-facts-separately-from-natural-prose.md)
