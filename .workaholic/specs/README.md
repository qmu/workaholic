...
Viewpoint-based architecture specifications for the Workaholic plugin system. Each viewpoint analyzes the codebase from a different perspective. Viewpoint documents are generated by the `/scan` command.
