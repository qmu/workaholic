...
- [Explicit] Vendor Neutrality and Ubiquitous Language are policies of `leading-availability` and `leading-validity` respectively; both apply across the codebase as cross-cutting concerns.
