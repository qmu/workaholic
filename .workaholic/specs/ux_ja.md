...
**新パターン**:
- `/report` が `bash ~/.claude/plugins/marketplaces/workaholic/plugins/core/skills/branching/sh/check-version-bump.sh` を使用して現在の branch の既存「Bump version」commit をチェック
