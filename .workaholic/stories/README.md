...
- [drive-20260131-223656.md](drive-20260131-223656.md) - Workflow quality-of-life improvements: fail/ directory renamed to abandoned/ for UI alignment, branch naming standardized to drive-/trip- only, hook error messages guide Claude to create-ticket skill, archive script invocation made explicit to prevent hallucination - 4 tickets, 13 commits
