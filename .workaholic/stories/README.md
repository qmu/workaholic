...
- [drive-20260131-223656.md](drive-20260131-223656.md) - Systematic terminology alignment and documentation clarity: fail/ directory renamed to abandoned/, branch naming standardized to drive-/trip- prefixes only, hook error messages point to create-ticket skill, archive script invocation guidance clarified - 4 tickets, 8 commits
