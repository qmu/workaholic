...
- [feat-20260126-214833.md](feat-20260126-214833.md) - Subagent architecture with concurrent execution, git -C prohibition via settings.json deny, skill extraction, bundled scripts for permission-free plugins, and infrastructure improvements (POSIX sh, topic tree flowchart, ticket directory reorganization) - 33 tickets, 81 commits
