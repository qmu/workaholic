...
- [feat-20260131-125844_ja.md](feat-20260131-125844_ja.md) - Skill モジュール化と並列最適化による architectural 改善: skill-to-skill nesting、drive-workflow を 4 つの skill に分割、isolated context 用の driver agent、performance-analyst を Phase 1 並列実行に移動、generate-changelog を統合、intelligent ticket prioritization、structured commit message、selective option 強制、dependency graph 再構成 - 14チケット、25コミット
