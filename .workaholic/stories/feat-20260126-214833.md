...
flowchart LR
  ...
  subgraph Commands[Command Simplification]
    c1[Remove /sync] --> c2[Remove /commit] --> c3[Rename to /report] --> c4[Rename to terms]
  end

  subgraph Skills[Skill Extraction]
    k1[changelog script] --> k2[story-metrics script] --> k3[spec-context script] --> k4[pr-ops script] --> k5[drive-workflow]
  end

  subgraph Infra[Infrastructure]
    i1[Convert to POSIX sh] --> i2[Use REST API] --> i3[i18n as skill]
  end
