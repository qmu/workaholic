...
flowchart TD
  ...
  Subagents --> sync --> story --> changelog --> pr-creator

  GitSafety[Git Command Safety]
  GitSafety --> guidelines --> strengthen --> embed --> deny-rule

  Skills[Skill Extraction]
  Skills --> changelog-skill & story-metrics & spec-context & pr-ops

  Commands[Command Simplification]
  Commands --> remove-sync & remove-commit & rename-pr & rename-terms

  Infra[Infrastructure]
  Infra --> posix-sh & rest-api & i18n-skill
```
