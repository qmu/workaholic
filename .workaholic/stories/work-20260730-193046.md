...
- **When:** 2026-07-30T19:53:59+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size/too-large-commit on the merge commit 0af43545 (1013 non-generated changed lines) -- a merge commit inherently carries the merged branch's whole diff, which is the clearest case of the metric not measuring throughput; no secret or leak findings; covered by the developer's override of this rule for this PR at ship time
...
- **Method:** other
- **Status:** pass
- **Observed:** Pre-merge proof per the deployment contract: outputs/ fresh after rebuild, verify.mjs + validate-metadata.mjs pass, hermetic suite 1533 passed / 0 failed (combining both branches' coverage), version 1.0.112 consistent across all five lockstep files, posix-lint and layout-doctor conforming. Merge reconciliation verified: all five test functions from both branches present and registered, both story index lines kept
