...
- **When:** 2026-08-04T12:52:32+09:00
- **By:** a@qmu.jp
- **Target:** Workaholic marketplace plugin
- **Method:** other (branch/staging proof per the deployment contract)
- **Status:** pass
- **Observed:** reconciled with main and re-bumped past the 1.0.124 collision to 1.0.125; outputs fresh (0 changes after rebuild); verify.mjs and validate-metadata.mjs report all five version files aligned at 1.0.125; test-workflow-scripts.mjs 2095 passed 0 failed; layout-doctor conforming; branch-safety scan pass
