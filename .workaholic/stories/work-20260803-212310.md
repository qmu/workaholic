...
- **When:** 2026-08-03T22:24:34+09:00
- **By:** a@qmu.jp
- **Target:** Workaholic marketplace plugin
- **Method:** other
- **Status:** pass
- **Observed:** outputs fresh; verify+metadata pass; 2041 tests pass; v1.0.123 consistent; layout conforming with releases/ registered; scan: size findings on catch-up merge (3702 inherited) and ticket f11e45f0 (527 vs 500) overridden by developer merge instruction
