...
- **When:** 2026-08-04T12:39:40+09:00
- **By:** a@qmu.jp
- **Target:** release-scan
- **Method:** override
- **Status:** bypassed
- **Observed:** size/too-large-commit on 991f0025 (877 non-generated lines > 500). That commit is the catch-up MERGE of origin/main; every one of its lines is PR #179/#180 work already reviewed and already on main, authored by no commit of this branch. Overridden on the developer's explicit merge instruction.

## Deployment Evidence

- **When:** 2026-08-04T12:40:35+09:00
- **By:** a@qmu.jp
- **Target:** Workaholic marketplace plugin
- **Method:** other (branch/staging proof per the deployment contract)
- **Status:** pass
- **Observed:** reconciled with main; outputs fresh (0 changes after rebuild); verify.mjs and validate-metadata.mjs pass; test-workflow-scripts.mjs 2075 passed 0 failed; version 1.0.123 consistent (no bump on this branch by design)
