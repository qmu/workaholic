...
flowchart TD
    ...
    B --> E["release: abort, release, retire,<br/>and a reap for the merge"]
...
### A lock leaked between winning and pushing needs a later take to sweep it

- **Severity:** moderate
- **Description:** A process killed in the seconds between winning a lock and pushing its branch leaves a lock nothing releases until the next lost take runs the reap (see [00e4df36](https://github.com/qmu/workaholic/commit/00e4df36) in `plugins/workaholic/skills/drive/scripts/claim-arbitrate.sh`)
