...
The version was bumped to v1.0.309 and generated workflow output rebuilt. The release scan's sole finding is the existing `override`-tier size of `scripts/e2e/loop-drill.sh`, the repository's cumulative drill register.
