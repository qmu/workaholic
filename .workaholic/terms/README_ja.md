...
- [core-concepts_ja.md](core-concepts_ja.md) - Plugin、command、skill、rule、agent、orchestrator、deny、preload、nesting-policy、hook、PostToolUse、TiDD、context-window、viewpoint、architecture-analyst、policy-analyst、scanner、validate-writer-output
