...
1. Create a separate rule file `plugins/core/rules/i18n-work-docs.md` scoped to `.workaholic/` directory:
...
- This applies to the `.workaholic/` directory which allows i18n content per CLAUDE.md
...
- **Change**: Created separate rule file `i18n-work-docs.md` instead of adding to `general.md`
  **Reason**: User requested scoping the rule specifically to `.workaholic/` directory
