...
- **Reader** — `drive/scripts/list-claims.sh`: pure read, emits `{fetched, stale_hours, base, claims: [{unit, branch, artifacts, last_commit_at, stale}]}`.
