...
description: "Building export, deletion, and data-use transparency as first-class features so users retain meaningful control over their own data."
resource: https://qmu.co.jp/design/data-sovereignty
tags:
  - design
  - data-sovereignty
---
...
Data sovereignty connects to consent management — [Recording of Policy Changes and Consent](/design/consent-recording.md) — and to legal compliance — [Legal Compliance Verification](/planning/legal-compliance-check.md). The schema design practices that support deletion semantics are covered in [Schema-First Database Design](/implementation/persistence.md).
