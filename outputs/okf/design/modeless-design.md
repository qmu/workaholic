...
description: "Making modelessness the design starting point and introducing modals only where concentration is truly warranted, so users and AI agents can reach any operation without navigating mode state."
...
Related: [Accessibility](/planning/accessibility-first.md).
