...
description: "Using managed services as development scaffolding while keeping the deployment unit as a single modular monolith; splitting into separate services only when the boundary is justified and the rationale is documented."
resource: https://qmu.co.jp/design/modular-monolith-first
tags:
  - design
...
See [Conservative Vendor Dependence](/design/vendor-neutrality.md), [Capacity and Recovery Planning](/implementation/operational-planning.md), and [Domain Layer Separation](/implementation/domain-layer-separation.md) for related policies.
