...
description: "Using containers to make the local development environment match production and to make the deployment unit reproducible, with multi-stage builds, pinned base image versions, and non-root runtime users."
resource: https://qmu.co.jp/implementation/containerization
tags:
  - implementation
  - containerization
---
