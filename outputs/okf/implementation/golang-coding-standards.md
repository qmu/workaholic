...
Go package contents are divided by role. While [Standard Directory Structure](/implementation/directory-structure.md) covers the repository-wide layout up to `packages/<package>/`, this section covers the inside of a Go package:
