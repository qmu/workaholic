...
The choice of tool is evaluated in line with [Conservative Vendor Dependence](/design/vendor-neutrality.md).
...
IaC should be executed by [Local CI/CD Execution](/operation/ci-cd.md). Reproducibility supports [Conservative Vendor Dependence](/design/vendor-neutrality.md). Whether the resources defined by IaC are behaving as expected is confirmed through [Observability and Self-Healing](/implementation/observability.md).
