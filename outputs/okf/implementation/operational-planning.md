...
description: "Holding \"how much can it handle\" and \"how do we recover\" in a simple form from the build stage, deriving RTO/RPO from concrete failure scenarios rather than abstract availability targets, without importing complexity through over-planning."
resource: https://qmu.co.jp/implementation/operational-planning
tags:
  - implementation
