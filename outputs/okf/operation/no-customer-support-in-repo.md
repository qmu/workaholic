...
description: "Routing customer support communication through a dedicated support channel rather than the GitHub issue tracker, keeping the engineering backlog and the support queue separate."
resource: https://qmu.co.jp/operation/no-customer-support-in-repo
tags:
  - operation
  - no-customer-support-in-repo
---
...
The engineering issue tracker is maintained as a clean engineering backlog — see [CI/CD Automation](/operation/ci-cd.md) for the standards that keep the engineering pipeline healthy. For cases where a reported issue may indicate a production problem, see [AI-Assisted Production Investigation](/operation/ai-production-investigation.md).
