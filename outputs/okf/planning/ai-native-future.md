...
description: "Building in the premise that software users will include AI agents as well as humans, ensuring AI-driven processes remain observable and interruptible by humans."
resource: https://qmu.co.jp/planning/ai-native-future
tags:
  - planning
  - ai-native-future
---
...
Related: [Requirements Analysis through Modeling](/planning/modeling-centric-design.md), [Accessibility Open to AI](/planning/accessibility-first.md), and [AI-Assisted Production Investigation](/operation/ai-production-investigation.md).
