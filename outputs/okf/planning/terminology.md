...
description: "Collecting established project terms into a dictionary with one word per concept, used consistently across code, documents, commits, diagrams, and conversation to keep the codebase self-explanatory for humans and AI agents alike."
resource: https://qmu.co.jp/planning/terminology
tags:
  - planning
  - terminology
---
...
Related: [Requirements Analysis through Modeling](/planning/modeling-centric-design.md).
