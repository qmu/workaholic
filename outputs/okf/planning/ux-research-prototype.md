...
description: "Verifying requirements through working prototypes that clients and users can try, surfacing misalignments between stated requests and actual experience before design solidifies."
resource: https://qmu.co.jp/planning/ux-research-prototype
tags:
  - planning
...
Related: [Requirements Analysis through Modeling](/planning/modeling-centric-design.md) and [Proactive PoC Proposals](/planning/proactive-poc.md).
