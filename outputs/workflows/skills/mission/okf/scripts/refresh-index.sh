...
" ;;
    moderations)  root_body="$root_body* moderations/ - the /moderate tick log, one file per UTC day (an operational log, not knowledge: no type:, no index, and git-ignored - it stays in the checkout and is committed nowhere)
" ;;
