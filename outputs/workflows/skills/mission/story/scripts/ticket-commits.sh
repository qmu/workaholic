...
# pointing at an orphaned, never-pushed commit (every /story link built from it 404s).
...
# and ignores later edits to the file (a later /story touch-up must not re-point the
