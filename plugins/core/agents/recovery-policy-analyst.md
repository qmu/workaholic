...
3. **Write English Policy**: Write `.workaholic/policies/recovery.md` following the preloaded analyze-policy skill. Include Observations and Gaps sections. Only document implemented and executable policies. Cite the enforcement mechanism for each statement.
