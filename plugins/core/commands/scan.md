...
```bash
bash ${CLAUDE_PLUGIN_ROOT}/../standards/skills/validate-writer-output/scripts/validate.sh .workaholic/policies test.md security.md quality.md accessibility.md observability.md recovery.md
```
