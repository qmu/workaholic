...
```bash
bash ~/.claude/plugins/marketplaces/workaholic/plugins/drivin/skills/select-scan-agents/sh/select.sh full
```
...
```bash
bash ~/.claude/plugins/marketplaces/workaholic/plugins/drivin/skills/validate-writer-output/sh/validate.sh .workaholic/specs ux.md model.md usecase.md infrastructure.md application.md component.md data.md feature.md
```

Validate policy output:

```bash
bash ~/.claude/plugins/marketplaces/workaholic/plugins/drivin/skills/validate-writer-output/sh/validate.sh .workaholic/policies test.md security.md quality.md accessibility.md observability.md delivery.md recovery.md
```
