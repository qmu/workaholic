...
8. **Never duplicate the primary language as a translation** - If the primary language is Japanese, do not produce `_ja.md` translations (they would duplicate the primary content). Translations complement the primary language, not repeat it.

## .workaholic/ Directory

For `.workaholic/` specific i18n requirements, see the `i18n` skill which is preloaded by documentation agents.
