...
`accept-observation.sh`. Preserve the selected sender. Provider-specific lookup names below
describe capabilities, not permission to bypass the transport seam.
