...
slug: access-control
category: design
source: https://qmu.co.jp/design/access-control
---
...
Mechanism selection follows from the auth procurement decision — see [Authentication and Authorization Procurement Policy](auth-procurement.md). Row-level security is a complement to [Schema-First Database Design](../../implementation/policies/persistence.md). Both are one layer in a defense-in-depth posture — see [Security Considered in Layers](defense-in-depth.md).
