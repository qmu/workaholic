...
slug: admin-isolation
category: design
source: https://qmu.co.jp/design/admin-isolation
---
...
Admin isolation is one layer in the defense-in-depth posture described in [Security Considered in Layers](defense-in-depth.md). The authentication event for the admin surface follows the procurement considerations in [Authentication and Authorization Procurement Policy](auth-procurement.md). Admin operation logs are part of the structured logging posture in [Observability and Self-Healing](../../implementation/policies/observability.md).
