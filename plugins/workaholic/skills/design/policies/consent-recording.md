...
slug: consent-recording
category: design
source: https://qmu.co.jp/design/consent-recording
---
...
- Consent obtained via a dark pattern — pre-checked boxes, buried disclosure, or misleading language — see [Elimination of Dark Patterns](no-dark-patterns.md).
...
Consent records are part of the broader data sovereignty commitment — [Respecting User Data Sovereignty](data-sovereignty.md). Consent flows must not use dark patterns — [Elimination of Dark Patterns](no-dark-patterns.md). The legal requirements that drive consent obligations are enumerated in [Legal Compliance Verification](../../planning/policies/legal-compliance-check.md).
