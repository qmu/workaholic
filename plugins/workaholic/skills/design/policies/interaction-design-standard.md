...
slug: interaction-design-standard
category: design
source: https://qmu.co.jp/design/interaction-design-standard
---
...
Consistent interaction states support [Modeless Design](modeless-design.md) by making the modeless surface learnable. Well-defined states remove the need for documentation — [UI That Requires No Manual](self-explanatory-ui.md). Keyboard navigation and ARIA state consistency connect directly to [Accessibility Open to AI](../../planning/policies/accessibility-first.md).
