...
slug: per-tenant-database
category: design
source: https://qmu.co.jp/design/per-tenant-database
---
...
The isolation model decision is a schema design decision — [Schema-First Database Design](../../implementation/policies/persistence.md). Row-level security as an access control mechanism is discussed in [Access Control Mechanism Selection](access-control.md). Tenant data isolation is a layer in the defense-in-depth posture — [Security Considered in Layers](defense-in-depth.md).
