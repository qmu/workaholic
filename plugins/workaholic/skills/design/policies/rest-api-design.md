...
category: design
source: https://qmu.co.jp/design/rest-api-design
---
...
A REST API that follows standard conventions is composable — it can be called in any order, by any client, without prior mode state. This supports [Modeless Design](modeless-design.md) at the API layer. Standard, documented APIs are also more navigable by AI agents — see [Accessibility Open to AI](../../planning/policies/accessibility-first.md).
