...
Related: [Requirements Analysis through Modeling](../../planning/policies/modeling-centric-design.md), [Codifying Domain Terminology](../../planning/policies/terminology.md), [Preferring Rich Typing](../../implementation/policies/type-driven-design.md).
