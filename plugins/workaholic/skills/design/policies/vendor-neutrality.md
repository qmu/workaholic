...
category: design
source: https://qmu.co.jp/design/vendor-neutrality
---
...
This policy covers the design level — which services and platforms to adopt, how to interface with them, and how to bound the surface of dependency. The implementation-level stance on vendor dependence is in the implementation pillar's [Conservative Vendor Dependence](../../implementation/policies/vendor-neutrality.md) policy.
...
This policy covers the design-level choice; the implementation-level practices are in [Conservative Vendor Dependence](../../implementation/policies/vendor-neutrality.md). Service proliferation accelerates when moving to distributed systems — see [Cautious Consideration of Distributed Systems](modular-monolith-first.md). Auth service selection is a specific application of this policy — see [Authentication and Authorization Procurement Policy](auth-procurement.md).
