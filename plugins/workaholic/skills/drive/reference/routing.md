...
- **AND EVERY OTHER REPORTED CLAIM THIS RUN CAN STILL CATCH UP** (2026-08-30, mission
  ...
  ```bash
  bash ${CLAUDE_PLUGIN_ROOT}/skills/drive/scripts/list-catchable-claims.sh
  ```
