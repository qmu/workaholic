#!/bin/sh -eu
# Step 5 — triage stale issues and drift between GitHub and .workaholic/.
#
...
printf '{"step": "issue-triage", "status": "skipped", "reason": "not_implemented", "summary": "not implemented yet (ticket 20260817113752-implement-the-repository-hygiene-steps.md)", "needs_agent": []}\n'
