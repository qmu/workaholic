#!/bin/sh -eu
# Step 4 — report pull requests whose merge is blocked by conflict state.
#
...
#
# Usage: merge-conflicts.sh --tick <id> --root <repo-root>
# Output: one JSON line {"step","status","reason","summary","needs_agent":[]}

set -eu

printf '{"step": "merge-conflicts", "status": "skipped", "reason": "not_implemented", "summary": "not implemented yet (ticket 20260817113752-implement-the-repository-hygiene-steps.md)", "needs_agent": []}\n'
