#!/bin/sh -eu
# Step 3 — read workload logs on any environment whose credentials are available.
#
...
printf '{"step": "workload-logs", "status": "skipped", "reason": "not_implemented", "summary": "not implemented yet (ticket 20260817113751-implement-the-inbound-sweep-steps.md)", "needs_agent": []}\n'
