...
slug: command-scripts
category: implementation
source: https://qmu.co.jp/implementation/command-scripts
---
...
The CI/CD policy depends on the scripts being reproducible locally — see [CI/CD Automation](../../operation/policies/ci-cd.md). Script naming and formatting conventions follow the same standards as code — [Coding Standards and Conventions](coding-standards.md).
