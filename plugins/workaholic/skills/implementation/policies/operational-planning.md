...
### Reference the recovery manifest from [Incident Response Procedure](../../safety/policies/incident-response.md) (復旧マニフェストを docs/safety/incident-response.md から参照する)

The per-scenario recovery procedures are placed where they can be referenced from the [Incident Response Procedure](../../safety/policies/incident-response.md).
...
Rollback automation is directly connected to [Local CI/CD Execution](../../operation/policies/ci-cd.md). Reproducibility presupposes [Conservative Vendor Dependence](../../design/policies/vendor-neutrality.md) and [Infrastructure as Code](infrastructure-as-code.md). Scaling decisions take the metrics of [Observability and Self-Healing](observability.md) as their input. Recovery in the event of a security incident references [Security Considered in Layers](../../design/policies/defense-in-depth.md) and the [Incident Response Procedure](../../safety/policies/incident-response.md).
