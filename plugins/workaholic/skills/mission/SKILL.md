...
| ---- | ----------------- | ---- |
| `/specificate`'s publish seam | `workaholic:specificate` step 9, `reference/workflow.md` | the original caller |
...
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/strategy/scripts/mission-strategy.sh <slug>
```
