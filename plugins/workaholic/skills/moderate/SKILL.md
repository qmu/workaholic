...
The ask (issue #471) named nine steps (there are twelve: the release reads merged in, and `stalled-units` was added 2026-08-23) and, at five points, met a decision the loop had already made. None of them is resolved by this skill quietly:
