...
STEPS='open-log inbound-sweep workload-logs merge-conflicts issue-triage stuck-prs doc-drift release-status note-cadence strategy-pace direction-health stalled-units undrivable-units undelivered-units retire-claims closable-missions strategy-digest unanswered-asks human-checkin'
