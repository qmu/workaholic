...
STEPS='open-log blocked-tick inbound-sweep workload-logs merge-conflicts issue-triage stuck-prs doc-drift release-status note-cadence strategy-pace direction-health date-will-not-hold stalled-units raced-units undrivable-units standing-rulings undelivered-units catchup-blocked handoff-units thread-reconcile stranded-publications operator-pulls retire-claims closable-missions base-health drill-health cadence-lapse strategy-digest question-answers unanswered-asks file-findings human-checkin'
