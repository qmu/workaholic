...
STEPS='open-log inbound-sweep workload-logs merge-conflicts issue-triage stuck-prs doc-drift release-status note-cadence strategy-pace direction-health stalled-units undrivable-units standing-rulings undelivered-units catchup-blocked handoff-units thread-reconcile retire-claims closable-missions base-health drill-health strategy-digest question-answers unanswered-asks file-findings human-checkin'
