...
- **[Verifying Before Building Out](policies/verify-before-building.md)** (作り込む前に確かめる) — Before committing to full development, verify small against real artifacts — PoCs, working prototypes, and internal labs — to reduce uncertainty around investment, requirements, experience, and technical feasibility.
