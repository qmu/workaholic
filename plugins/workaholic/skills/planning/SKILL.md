...
- **[Verify Before Building](policies/verify-before-building.md)** (作り込む前に確かめる) — Reducing uncertainty around investment, requirements, experience, and technical feasibility before full development by verifying small with the real thing — through PoC, working prototypes, and in-repository labs.
