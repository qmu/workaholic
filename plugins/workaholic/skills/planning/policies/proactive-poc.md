...
slug: proactive-poc
category: planning
source: https://qmu.co.jp/planning/proactive-poc
---
...
Related: [Upfront IT Investment Evaluation](it-investment-evaluation.md) and [UX Research through Prototypes](ux-research-prototype.md).
