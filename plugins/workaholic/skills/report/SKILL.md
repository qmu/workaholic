...
- **Close** a won't-fix or resolved concern:
  ...
  ```bash
  bash ${CLAUDE_PLUGIN_ROOT}/skills/report/scripts/close-concern.sh <concern-id> <resolved|accepted> "<reason>"
  ```
