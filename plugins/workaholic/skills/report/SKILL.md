...
- **Phase 0** — bump the version unless `check-version-bump.sh` says `already_bumped`; gather context via `bash ${CLAUDE_PLUGIN_ROOT}/skills/gather/scripts/git-context.sh`.
